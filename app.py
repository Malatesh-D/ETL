...
# =========================================================
# PROFESSIONAL SMART ETL ANALYTICS DASHBOARD
# =========================================================
...
if file:
    ...
    # =====================================================
    # AUTO TYPE DETECTION (SMART PART)
    # =====================================================
    ...
    categorical_cols = df.select_dtypes(
        exclude=["number", "datetime64", "datetime64[ns]"]
    ).columns.tolist()
    ...
    # ❗ only categorical allowed here (prevents datetime mistake)
    ...
    for metric in metric_cols:
        ...
        if category_col != "None":
            ...
            fig3 = px.bar(
                ...
                y=metric,
                text=metric,
                title="Top 10 Categories + Others"
            )
